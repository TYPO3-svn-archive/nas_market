...
$TCA['tx_nasmarket_domain_model_category'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'title,description,image,parent'
	),
	'types' => array(
		'1' => array('showitem' => 'title,description,image,parent')
	),
	'palettes' => array(
		'1' => array('showitem' => '')
	),
	'columns' => array(
		...
		'description' => array(
			'exclude' => 0,
			'label'   => 'LLL:EXT:nas_market/Resources/Private/Language/locallang_db.xml:tx_nasmarket_domain_model_category.description',
			'config'  => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
